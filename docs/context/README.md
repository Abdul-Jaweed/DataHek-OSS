...
|---|---|---|
| M1 | Repository analysis + research | **Complete — in review** |
| M2 | Architecture, SRD, ADRs, diagrams | Pending |
...
Further documents (architecture, SRD, ADRs, specifications) land here per milestone.
